...
const LINKS = [
  { group: 'Denně', items: [
    ...
    { name: 'Twitch',        url: 'https://www.twitch.tv', pin: true },
  ...
  { group: 'Práce a vývoj', items: [
    ...
    { name: 'Tryhackme',         url: 'https://tryhackme.com/dashboard',},
  ...
  { group: 'RP', items: [
    { name: 'SASP Personal',         url: 'https://personal.sast.cz', pin: true },
    { name: 'Tabulky Směna 1',       url: 'https://docs.google.com/spreadsheets/d/1O4gmMDqsWiQ99SiwmuXyA69OObdPQ1RKWhRqN2Yb9Ms/edit?gid=1344318557#gid=1344318557', pin: true },
    { name: 'Swat Personal',  url: 'https://swat.sast.cz/dashboard' },
    { name: 'SASP Dashboard',    url: 'https://sasp-bot.beecore.eu/dashboard' },
  ]},
  { group: 'Google', items: [
    { name: 'Mapy Google',    url:'https://www.google.com/maps' },
    { name: 'Gmail',        url: 'https://mail.google.com', pin: true },
    { name: 'Google Disk',  url: 'https://drive.google.com' },
    { name: 'Dokumenty',  url: 'https://docs.google.com/document/u/0/' },
    { name: 'Dokumenty',  url: 'https://docs.google.com/document/u/0/' },
    { name: 'Tabulky',  url: 'https://docs.google.com/spreadsheets/u/0/' },
  ]},
  { group: 'Zábava', items: [
    { name: 'YouTube', url: 'https://www.youtube.com',},
    { name: 'Jellyfin', url: 'http://jellyfin.home/web/#/home', pin: true},
  ...
  { group: 'Nákupy', items: [
    ...
    { name: 'Smarty',       url: 'https://www.smarty.cz' },
